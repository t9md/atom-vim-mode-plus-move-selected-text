...
module.exports = function loadVmpCommands(Base) {
  ...
  class MoveOrDuplicateSelectedText extends Operator {
    static initClass() {
      this.commandScope = "atom-text-editor.vim-mode-plus.visual-mode"
      this.commandPrefix = "vim-mode-plus-user"
    }
  ...
  MoveOrDuplicateSelectedText.initClass()
  ...
  class MoveSelectedText extends MoveOrDuplicateSelectedText {
    ...
    getCount(...args) {
      const count = super.getCount(...args)
  ...
  MoveSelectedTextDown.initClass()

  class MoveSelectedTextLeft extends MoveSelectedText {
    static initClass() {
      this.prototype.direction = "left"
    }
  ...
  MoveSelectedTextLeft.initClass()

  class MoveSelectedTextRight extends MoveSelectedTextLeft {
    static initClass() {
      this.prototype.direction = "right"
    }
  }
  MoveSelectedTextRight.initClass()
  ...
  class DuplicateSelectedText extends MoveOrDuplicateSelectedText {
    duplicateSelectionsLinewise() {
      let linewiseDisposable
      if (!this.vimState.isMode("visual", "linewise")) {
        linewiseDisposable = switchToLinewise(this.editor)
      }
      for (const selection of this.getSelections()) {
  ...
  DuplicateSelectedTextUp.initClass()
  ...
  DuplicateSelectedTextDown.initClass()
  ...
  DuplicateSelectedTextLeft.initClass()
  ...
  DuplicateSelectedTextRight.initClass()
